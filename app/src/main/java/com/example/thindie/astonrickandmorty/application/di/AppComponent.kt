...
interface BindsInstances {
    ...
    @Binds
    fun bindEpisodesBaseProvider(provider: EpisodeProvider)
            : BaseProvider<EpisodeDomain, EpisodeFilter>

    @Binds
    fun bindLocationsBaseProvider(provider: LocationProvider)
            : BaseProvider<LocationDomain, LocationsFilter>

    @Binds
    fun bindPersonageBaseProvider(provider: PersonageProvider)
            : BaseProvider<PersonageDomain, PersonageFilter>
}
...
interface RepositoryModule {
    ...
    @Binds
    fun bindEpisodesBaseProvider(provider: EpisodeRepository)
            : BaseRepository<EpisodeDomain>

    @Binds
    fun bindLocationsBaseProvider(provider: LocationRepository)
            : BaseRepository<LocationDomain>

    @Binds
    fun bindPersonageBaseProvider(provider: PersonageRepository)
            : BaseRepository<PersonageDomain>
