...
/*
data class LocationQueryModifier(
    val id: Int = 0,
    val name: String = "",
    val type: String = "",
    val dimension: String = "",
    val url: String = ApiParams.LOCATION.plus(id)
)

data class EpisodeQueryModifier(
    val id: Int = 0,
    val name: String = "",
    val episode: String = "",
    val url: String = ApiParams.EPISODE.plus(id)
)


data class CharacterQueryModifier(
    val id: Int = 0,
    val name: String = "",
    val status: String = "",
    val species: String = "",
    val type: String = "",
    val gender: String = "",
    val url: String = ApiParams.CHARACTER.plus(id)
)*/
